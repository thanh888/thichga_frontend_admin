...
export function BetSesionOtherComponent({ isReload, setIsReload }: Readonly<Props>): React.JSX.Element {
  ...
  return (
    <Card sx={{ bgcolor: '#e0e0e0', borderRadius: 4, boxShadow: 3, p: 2 }}>
      <Stack direction="row" justifyContent="space-between" alignItems="center">
        <Typography variant="h5">Danh sách phiên</Typography>
      </Stack>
...
export default BetSesionOtherComponent;
